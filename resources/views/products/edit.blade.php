            ...
            <div class="card-body">
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="productId" placeholder="Enter Product ID" name="product_id" value="{{ $product->product_id }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="stock" placeholder="Enter Stock" name="stock" value="{{ $product->stock }}">
                    </div>
                    <div class="form-group">
